...
|ADD Rx, Ry, Rz  |0x20   |R-Type |Adds Rx and Ry together and stores the result in Rz|
|SUB Rx, Ry, Rz  |0x21   |R-Type |Subtracts Ry from Rx and stores the result in Rz|
|AND Rx, Ry, Rz  |0x30   |R-Type |Stores the bitwise result of Rx & Ry in Rz|
|OR Rx, Ry, Rz   |0x31   |R-Type |Stores the bitwise result of Rx | Ry in Rz|
|XOR Rx, Ry, Rz  |0x32   |R-Type |Stores the bitwise result of Rx ^ Ry in Rz|
